...
async function main() {
    ...
    const mentors = await Promise.all(families.map((family, i) => prisma.user.create({
        data: {
            id: `mentor-${i + 1}`,
    ...
    const announcements = await Promise.all([
        prisma.announcement.create({
            data: {
                ...
                content: 'Welcome to the ACE mentorship program! We are excited to have you join us this semester. Please make sure to submit your weekly meetup photos.',
                authorId: admin.id,
                isPublished: true,
                isPinned: true,
        ...
        prisma.announcement.create({
            data: {
                ...
                content: 'This week, earn 15 bonus points by taking a photo at any campus landmark with your mentor/mentee!',
                authorId: admin.id,
                isPublished: true,
                isPinned: false,
                publishedAt: new Date(),
        ...
        prisma.announcement.create({
            data: {
                ...
                content: 'Join us for the family mixer event on February 15th at Coffman Union. Food and games will be provided!',
                authorId: admin.id,
                isPublished: false,
                isPinned: false,
