                    ...
                    <Card className="doraemon-shadow">
                        <CardContent className="p-6 md:p-8">
                            ...
                            <div className="flex justify-between mt-8 pt-6 border-t">
                                ...
                                {step < TOTAL_STEPS ? (
                                    <Button onClick={handleNext} className="gap-2 doraemon-gradient text-white">
                                        Next
                                        <ArrowRight className="w-4 h-4" />
                                    </Button>
                                ) : (
                                    <Button onClick={handleSubmit} disabled={isSubmitting} className="gap-2 doraemon-gradient text-white">
                                        {isSubmitting ? (
                                            <>
