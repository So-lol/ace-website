...
const currentWeek = {
    weekNumber: 5,
    year: 2026,
    deadline: 'Sunday, February 2nd at 11:59 PM'
}

const bonusActivities = [
    { id: '1', name: 'Study Session Together', description: 'Take a photo at a library or study space', points: 5 },
    { id: '2', name: 'Game Night', description: 'Play video games or board games together', points: 5 },
]
...
export default function SubmitPage() {
    ...
    const basePoints = 10
    const bonusPoints = selectedBonuses.length * 5
